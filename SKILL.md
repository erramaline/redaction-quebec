...
name: quebecois
description: |
  Révise et humanise un texte français pour qu'il respecte les normes de l'Office québécois de la langue française (OQLF) et qu'il sonne comme l'écriture d'un humain, pas d'un robot. En une seule passe, corrige l'espacement de la ponctuation, l'écriture des nombres et symboles monétaires, les espaces insécables réelles, les abréviations de civilité sans point (Mme, Dr vs M.), les ordinaux (2d/2de vs 2e), les rectifications orthographiques de 1990, la rédaction épicène, les majuscules institutionnelles, puis détecte 23 patrons d'écriture artificielle et applique 12 principes d'humanisation profonde (régularité structurelle, transitions scolaires, vocabulaire artificiellement soutenu, sur-explication, symétrie, dépolissage). Le but est de réécrire spontanément sans chercher à optimiser la prose : éviter les transitions systématiques et les formulations trop équilibrées, conserver certaines répétitions naturelles, et reproduire une voix personnelle et crédible plutôt qu'un texte indétectable par l'IA. Utilise ce skill dès qu'un texte français est rédigé, corrigé, révisé, traduit, humanisé ou reformaté pour un public québécois ou canadien-français, ou dès que l'utilisateur mentionne le Québec, l'OQLF, la BDL, le GDT, la rédaction épicène, l'humanisation ou des normes québécoises.
---

# Québécois

Un seul skill pour deux objectifs : rendre un texte français conforme aux normes institutionnelles de l'OQLF et le faire sonner comme l'écriture d'une personne réelle. 

**Mandat central de réécriture :** Réécrire spontanément. Conserver les concepts, les sources et la rigueur académique, mais ne jamais chercher à optimiser la prose. Éviter les transitions systématiques, les phrases qui résument le paragraphe précédent, les structures parallèles, les formulations trop équilibrées et le vocabulaire académique générique. Conserver certaines formulations simples et certaines répétitions naturelles. Ne pas chercher à produire un texte "indétectable par l'IA", mais plutôt chercher à reproduire une voix personnelle, crédible et cohérente avec le contexte professionnel de l'auteur.
...
Les sections suivantes contiennent les règles exhaustives de l'OQLF et les définitions complètes des patrons d'humanisation. Ce fichier unique contient tout le contexte nécessaire.



<!-- DEBUT ponctuation.md -->
...
- Web / affichage numérique sans garantie d'insécable : aucune espace avant (pour éviter qu'un deux-points ne commence une ligne).
- Expressions de l'heure en chiffres (13:52:45) : aucune espace de part et d'autre.

## Point-virgule ( ; ), point d'exclamation ( ! ), point d'interrogation ( ? )
- Aucune espace avant, quel que soit le support — contrairement à la norme française hexagonale, qui exige une espace fine insécable avant ces trois signes. Ne pas appliquer cette convention française.
- Espace sécable standard après.
...
- Toujours exactement trois points, jamais plus.
- Aucune espace avant (collés au mot précédent).
- Espace sécable après, sauf devant une parenthèse ou un crochet fermant.
- En fin de phrase, ils remplacent le point final — ne jamais cumuler.

## Jonctions de signes adjacents
Quand un signe sans espace avant (`; ! ?`) suit immédiatement un guillemet fermant ou des points de suspension, ne pas insérer d'espace à la jonction : `»!`, `»?`, `»;`, `...?`.

## Tableau récapitulatif
| Signe | Avant | Après | Déviation vs norme française |
|---|---|---|---|
| : | insécable (ou aucune sur Web) | sécable | France : espace fine ou forte obligatoire |
| ; | aucune | sécable | France : espace fine insécable obligatoire |
| ? | aucune | sécable | France : espace fine insécable obligatoire |
| ! | aucune | sécable | France : espace fine insécable obligatoire |
| « » | sécable / insécable | insécable / sécable | identique |
| " " (niveau 2) | aucune | aucune | — |
| ... | aucune | sécable | identique |

<!-- FIN ponctuation.md -->


<!-- DEBUT nombres-et-symboles.md -->
...
<!-- FIN nombres-et-symboles.md -->


<!-- DEBUT redaction-epicene.md -->
# Rédaction épicène (norme OQLF)

L'OQLF ne recommande que la rédaction épicène — elle rejette formellement les procédés typographiques parfois appelés « écriture inclusive » ailleurs dans la francophonie.

## Ordre de priorité des procédés
1. Désignation neutre : le personnel, la direction, le corps professoral.
2. Terme épicène : les spécialistes, les membres, les responsables.
3. Reformulation neutre de la phrase : « Pour obtenir un remboursement... » plutôt que « Si vous êtes inscrit... ».
4. Doublet complet, seulement si un terme sexué est nécessaire : les chercheuses et les chercheurs, les citoyennes et les citoyens. L'ordre des genres peut être alphabétique ou varier dans le texte.

## Procédés proscrits dans un texte suivi
Ne jamais utiliser, dans un texte courant : point médian (`·`), point simple, tiret, ou majuscule interne pour fusionner féminin/masculin — `étudiant·e·s`, `directeur.trice`, `étudiant-e-s` sont tous à reformuler en doublet complet ou tournure neutre. Motifs de l'OQLF : blocage à la lecture à voix haute, problèmes d'accord syntaxique avec adjectifs/participes, obstacles d'accessibilité pour les synthèses vocales.

Les doublets abrégés entre parenthèses (`étudiant(e)s`) ne sont tolérés que dans des contextes d'affichage très restreints (formulaires, tableaux, interfaces à espace limité) — jamais dans un texte suivi normal.

## Néologismes non reconnus
L'OQLF ne reconnaît pas les pronoms ou néologismes neutres non binaires (`iel`, `illes`, `frœur`) : le système grammatical du français n'a pas de genre neutre morphologique codifié. Utilise la rédaction épicène à la place.

<!-- FIN redaction-epicene.md -->


<!-- DEBUT majuscules.md -->
# Majuscules institutionnelles et administratives (norme OQLF)

## Titres de fonction, professions, charges
Toujours en minuscule, quel que soit le rang hiérarchique, même en s'adressant directement à la personne : le premier ministre du Québec, la ministre des Finances, le maire de Montréal, la directrice générale, le président-directeur général. (La majuscule de début de phrase s'applique normalement si le titre ouvre la phrase — règle générale du français, indépendante de celle-ci.)

## Unités administratives
Majuscule au premier mot constitutif (et aux adjectifs qui le précèdent), reste en minuscules : la Direction des ressources humaines, la Vice-présidence aux affaires financières, le Service de la comptabilité, le Département de linguistique. Exception : quand le mot désigne l'activité ou le concept général plutôt que l'entité précise, minuscule maintenue — « Ce service est actuellement fermé. »

## Lois, codes, règlements, chartes
Majuscule au premier terme désignant la nature du texte légal : la Charte de la langue française, la Loi sur la protection des renseignements personnels dans le secteur privé, le Code du travail. Textes non promulgués (en projet) : minuscule — le projet de loi n° 96, le projet de règlement.

## Majuscule elliptique
Quand une entité, un organisme ou un texte législatif a déjà été nommé en toutes lettres plus haut dans le texte, ses mentions ultérieures par le seul nom générique + article défini gardent la majuscule : « L'Office québécois de la langue française a publié ses directives. L'Office rappelle que... » / « La Charte de la langue française encadre la rédaction. La Charte protège le droit du public. » Cette règle ne s'applique pas aux simples unités administratives internes : « La Direction des affaires juridiques a analysé le dossier. La direction conclut que... » (minuscule à la deuxième mention).

<!-- FIN majuscules.md -->


<!-- DEBUT orthographe-1990.md -->
# Rectifications orthographiques de 1990 (norme OQLF)

## Principe d'équivalence
Les graphies traditionnelle et rectifiée sont toutes deux correctes. Un texte n'est jamais fautif pour avoir choisi l'une ou l'autre.

## Règle d'or : uniformité intra-document
Un même mot doit garder la même graphie partout dans un même texte. Il est interdit d'écrire « août » dans un paragraphe et « aout » dans un autre du même document.

L'application peut être partielle mot par mot (ex. : « cogestion » sans trait d'union tout en gardant « coût » avec circonflexe), du moment que chaque mot individuel reste constant dans tout le texte.

## Simplifications privilégiées par défaut
Si l'utilisateur n'indique pas de préférence contraire, applique ces tendances (et reste ensuite cohérent) :

- Soudure des mots préfixés/composés : hypertexte, autosuffisance, portefeuille, motomarine.
- Francisation des emprunts : scouteur, kéfir, nénufar.
- Harmonisation des accents é → è devant une syllabe contenant un e muet, y compris au futur/conditionnel et aux inversions interrogatives : il répètera, évènement, réglementation, aimè-je.
- Suppression du circonflexe sur i et u quand il ne distingue pas de sens : aout, cout, parait, connaitre — mais le conserver quand il a une fonction distinctive : dû (vs du), mûr (vs mur), sûr (vs sur).

## Procédure de vérification
Avant de livrer un texte : relève chaque mot concerné par une variante 1990, vérifie qu'il n'apparaît pas ailleurs dans le texte sous l'autre graphie, et uniformise au besoin.

<!-- FIN orthographe-1990.md -->


<!-- DEBUT humanisation.md -->
